                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="apellido_paterno" id="apellido_paterno"
                                           ...
                                           value="{{ old('apellido_paterno') }}" placeholder="Ingrese el apellido paterno">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="apellido_materno" id="apellido_materno"
                                           ...
                                           value="{{ old('apellido_materno') }}" placeholder="Ingrese el apellido materno">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nombres" id="nombres"
                                           ...
                                           value="{{ old('nombres', old('name')) }}" placeholder="Ingrese el/los nombre(s)" required>
                                    @error('nombres')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
