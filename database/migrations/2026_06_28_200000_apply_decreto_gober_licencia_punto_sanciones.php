...
return new class extends Migration
{
    ...
    private function rows(): array
    {
        return [
            ...
            $this->row('419', 'II', 'a,c', 'MOTO_LUCES_CASCO_DECRETO', 'Motocicleta sin luces encendidas o sin casco conforme a especificaciones', 1, true, false, false, false, false, 'Las personas conductoras de motocicletas que infrinjan los incisos a) y c) seran sancionadas con amonestacion y un punto de penalizacion a la licencia para conducir.'),
            $this->row('419', 'II', 'b,d', 'MOTO_PASAJEROS_CASCO_DECRETO', 'Motocicleta con exceso de personas o incumplimiento grave de casco', 3, false, true, false, false, true, 'En caso de infringir los incisos b) y d), se sanciona con arresto hasta por 36 horas, tres puntos de penalizacion a la licencia para conducir y remision de la motocicleta al deposito.'),
