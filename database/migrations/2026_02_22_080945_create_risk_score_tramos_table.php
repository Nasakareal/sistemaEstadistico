...
return new class extends Migration
{
    ...
    {
        Schema::create('risk_score_tramos', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(
                ['tramo_id', 'periodo_inicio', 'periodo_fin'],
                'uniq_risk_score_tramos_periodo'
            );
        });
    }
    ...
    {
        Schema::dropIfExists('risk_score_tramos');
    }
};
