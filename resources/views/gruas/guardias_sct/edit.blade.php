...
@section('title', 'Editar Guardia SCT')

@section('content_header')
    <h1>Editar Guardia SCT</h1>
@stop
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-outline card-warning">
                ...
                <div class="card-body">
                    <form action="{{ route('grua-guardias-sct.update', $guardia->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                                    ...
                                    <select name="grua_id" id="grua_id"
                                        ...
                                        @foreach($gruas as $grua)
                                            <option value="{{ $grua->id }}"
                                                {{ old('grua_id', $guardia->grua_id) == $grua->id ? 'selected' : '' }}>
                                                {{ $grua->nombre }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select name="tramo_id" id="tramo_id"
                                        ...
                                        @foreach($tramos as $tramo)
                                            <option value="{{ $tramo->id }}"
                                                {{ old('tramo_id', $guardia->tramo_id) == $tramo->id ? 'selected' : '' }}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="dia_inicio" id="dia_inicio"
                                           min="1" max="31"
                                           class="form-control @error('dia_inicio') is-invalid @enderror"
                                           value="{{ old('dia_inicio', $guardia->dia_inicio) }}"
                                           required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="dia_fin" id="dia_fin"
                                           min="1" max="31"
                                           class="form-control @error('dia_fin') is-invalid @enderror"
                                           value="{{ old('dia_fin', $guardia->dia_fin) }}"
                                           required>
