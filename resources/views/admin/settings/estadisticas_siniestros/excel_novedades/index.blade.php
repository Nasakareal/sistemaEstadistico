    ...
    <div class="sv-hero">
        <div class="sv-hero__inner">
            <div class="sv-hero__badge">
                ...
                <span>Siniestros · Excel Novedades · Cortes</span>
            </div>
            ...
            <div class="sv-hero__subtitle">
                Listado de archivos Excel generados por fecha
            </div>
        </div>
    </div>
@stop
            ...
            <div class="sv-panel">
                            ...
                            <tbody>
                                @foreach($cortes as $corte)
                                    <tr>
                                        ...
                                        <td>{{ $corte['archivo'] ?? '' }}</td>
                                        <td>
                                            <a href="{{ route('settings.estadisticas_siniestros.excel_novedades.descargar', $corte['fecha']) }}" class="btn sv-btn">
                ...
                @else
                    <div class="sv-empty">
                        ...
                        <div class="sv-empty__desc">Cuando se generen archivos Excel aparecerán aquí.</div>
                    </div>
                @endif
            </div>
        </div>
