...
@section('title', 'Editar Dispositivo Guardianes del Camino')

@section('content_header')
    <h1>Editar Dispositivo - Guardianes del Camino</h1>
@stop
        ...
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h3 class="card-title">Actualizar registro diario de actividades</h3>
                </div>

                <div class="card-body">
                    <form
                        id="form_dispositivo"
                        action="{{ route('guardianes_camino.dispositivos.update', $dispositivo->id) }}"
                        method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <div class="form-group mb-0">
                                    ...
                                    <a href="{{ route('guardianes_camino.dispositivos.show', $dispositivo->id) }}" class="btn btn-secondary">
