    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="cargo_responsable" id="cargo_responsable" class="form-control @error('cargo_responsable') is-invalid @enderror" value="{{ old('cargo_responsable', $dispositivoForm->cargo_responsable ?? '') }}" placeholder="Ejemplo: Of. Coronado Martinez Iroyochi">
        ...
        <div class="col-md-8">
            <div class="form-group">
                ...
                <input type="text" name="nombre_responsable" id="nombre_responsable" class="form-control @error('nombre_responsable') is-invalid @enderror" value="{{ old('nombre_responsable', $dispositivoForm->nombre_responsable ?? '') }}" placeholder="Nombre del responsable del reporte">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <select name="requiere_evidencia" id="requiere_evidencia" class="form-control @error('requiere_evidencia') is-invalid @enderror">
                    <option value="0" {{ old('requiere_evidencia', (int) ($dispositivoForm->requiere_evidencia ?? 0)) == 0 ? 'selected' : '' }}>No</option>
                    <option value="1" {{ old('requiere_evidencia', (int) ($dispositivoForm->requiere_evidencia ?? 0)) == 1 ? 'selected' : '' }}>Sí</option>
                </select>
