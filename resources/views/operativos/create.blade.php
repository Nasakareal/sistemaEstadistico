...
<div class="d-flex align-items-center justify-content-between">
    <div>
        ...
        <small class="text-muted">Capture únicamente los operativos realizados por su destacamento.</small>
    </div>
...
<div class="card shadow-sm">
    <form action="{{ route('operativos.store') }}" method="POST" enctype="multipart/form-data" id="form_operativos">
        @csrf
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="date" name="fecha" class="form-control"
                                    value="{{ old('fecha', now('America/Mexico_City')->toDateString()) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="time" name="hora" class="form-control"
                                    value="{{ old('hora', now('America/Mexico_City')->format('H:i')) }}" required>
                            </div>
                        </div>
                        ...
                        <table class="table table-bordered table-hover mb-0" id="tabla_operativos">
                            <thead class="bg-light">
                                <tr class="text-center align-middle">
                                    ...
                                    <th style="min-width: 180px;">Fotos</th>
                                </tr>
                            </thead>
                            <tbody>
                                    ...
                                    <tr class="fila-operativo" data-id="{{ $c->id }}">
                                        ...
                                        <td>
                                            <input type="number" min="0" class="form-control form-control-sm text-center campo-operativo"
                                                ...
                                                value="{{ old("items.$c->id.dispositivos_realizados", 0) }}">
                                        </td>

                                        <td>
                                            <input type="number" min="0" class="form-control form-control-sm text-center campo-operativo"
                                                name="items[{{ $c->id }}][vehiculos_inspeccionados]"
                                                value="{{ old("items.$c->id.vehiculos_inspeccionados", 0) }}">
                                        </td>

                                        <td>
                                            <input type="number" min="0" class="form-control form-control-sm text-center campo-operativo"
                                                name="items[{{ $c->id }}][personas_inspeccionadas]"
                                                value="{{ old("items.$c->id.personas_inspeccionadas", 0) }}">
                                        </td>

                                        <td>
                                            <input type="number" min="0" class="form-control form-control-sm text-center campo-operativo"
                                                name="items[{{ $c->id }}][vehiculos_impactados]"
                                                value="{{ old("items.$c->id.vehiculos_impactados", 0) }}">
                                        </td>

                                        <td>
                                            <input type="number" min="0" class="form-control form-control-sm text-center campo-operativo"
                                                name="items[{{ $c->id }}][personas_impactadas]"
                                                value="{{ old("items.$c->id.personas_impactadas", 0) }}">
                                        </td>

                                        <td>
                                            <input type="number" min="0" class="form-control form-control-sm text-center campo-operativo"
                                                name="items[{{ $c->id }}][estado_fuerza_participante]"
                                                value="{{ old("items.$c->id.estado_fuerza_participante", 0) }}">
                                        </td>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" name="totales[antecedentes_personas]" class="form-control"
                                    value="{{ old('totales.antecedentes_personas', 0) }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" name="totales[antecedentes_vehiculos]" class="form-control"
                                    value="{{ old('totales.antecedentes_vehiculos', 0) }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" name="totales[antecedentes_motos]" class="form-control"
                                    value="{{ old('totales.antecedentes_motos', 0) }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" name="totales[antecedentes_camiones]" class="form-control"
                                    value="{{ old('totales.antecedentes_camiones', 0) }}">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" name="totales[puestas_disposicion]" class="form-control"
                                    value="{{ old('totales.puestas_disposicion', 0) }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" name="totales[vehiculos_recuperados]" class="form-control"
                                    value="{{ old('totales.vehiculos_recuperados', 0) }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" name="totales[armas_aseguradas]" class="form-control"
                                    value="{{ old('totales.armas_aseguradas', 0) }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" name="totales[mercancia_recuperada]" class="form-control"
                                    value="{{ old('totales.mercancia_recuperada', 0) }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" name="totales[decomiso_drogas]" class="form-control"
                                    value="{{ old('totales.decomiso_drogas', 0) }}">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-outline card-secondary mb-0">
                ...
                <div class="card-body">
                    <textarea name="observaciones" class="form-control" rows="3"
                        placeholder="Observaciones generales del consolidado...">{{ old('observaciones') }}</textarea>
                </div>
            </div>
        ...
        <div class="card-footer text-right">
            ...
            <button type="submit" class="btn btn-primary" id="btn_guardar_operativos">
                <i class="fas fa-save mr-1"></i> Guardar consolidado
            </button>
        </div>
    </form>
</div>
...
<style>
    ...
    /* AQUÍ SE CORRIGE LA CELDA BLANCA DEL NOMBRE */
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        form.addEventListener('submit', function (e) {
            let total = 0;
            filas.forEach(fila => {
                if (fila.classList.contains('activa')) total++;
            });
            ...
            if (total === 0) {
                ...
                Swal.fire({
                    icon: 'warning',
                    title: 'Sin captura',
                    text: 'Debe capturar al menos un operativo con datos o fotografías.',
