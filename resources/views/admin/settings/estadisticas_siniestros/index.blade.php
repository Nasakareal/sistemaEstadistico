...
@section('title', 'Estadísticas Siniestros')
    ...
    <div class="sv-hero">
        <div class="sv-hero__inner">
            <div class="sv-hero__badge">
                ...
                <span>Siniestros · Reportes · Exportaciones</span>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-12">
            <div class="sv-card">
                ...
                <div class="sv-card__body">
                    <div class="sv-card__title">Parte de Novedades</div>
                    <div class="sv-card__desc">Listado y descarga de partes generados por fecha.</div>
                    <a href="{{ route('settings.estadisticas_siniestros.parte_novedades') }}" class="btn sv-btn">
        ...
        <div class="col-md-3 col-sm-6 col-12">
            <div class="sv-card">
                ...
                <div class="sv-card__body">
                    <div class="sv-card__title">Bitácora</div>
                    <div class="sv-card__desc">Consulta y descarga de bitácoras por periodo.</div>
                    <a href="{{ route('settings.estadisticas_siniestros.bitacora') }}" class="btn sv-btn">
                        <i class="fas fa-arrow-right"></i> Acceder
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-3 col-sm-6 col-12">
            <div class="sv-card">
                ...
                <div class="sv-card__body">
                    <div class="sv-card__title">Mini Parte</div>
                    <div class="sv-card__desc">Generación rápida y consulta de reportes compactos.</div>
                    <a href="{{ route('settings.estadisticas_siniestros.mini_parte') }}" class="btn sv-btn">
                        <i class="fas fa-arrow-right"></i> Acceder
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-3 col-sm-6 col-12">
            <div class="sv-card">
                ...
                <div class="sv-card__body">
                    ...
                    <div class="sv-card__desc">Consulta y descarga del concentrado diario de Siniestros en formato Excel.</div>
                    <a href="{{ route('settings.estadisticas_siniestros.excel_diario') }}" class="btn sv-btn">
                        <i class="fas fa-arrow-right"></i> Acceder
                    </a>
                </div>
            </div>
...
@section('js')
    <script> console.log("Estadísticas de Siniestros con estilo SV."); </script>
@stop
