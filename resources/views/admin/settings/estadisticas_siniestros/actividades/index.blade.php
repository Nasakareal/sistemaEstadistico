    ...
    <div class="sv-hero">
        <div class="sv-hero__inner">
            <div class="sv-hero__badge">
                ...
                <span>Siniestros · Actividades · Cortes</span>
            </div>
            ...
            <div class="sv-hero__subtitle">
                Listado de informes diarios disponibles para descarga
            </div>
        </div>
    </div>
@stop
        ...
        <div class="col-12">
            <div class="sv-panel">
                <div class="sv-panel__header">
                    <div>
                        <div class="sv-panel__title">Informes generados</div>
                        <div class="sv-panel__desc">Selecciona una fecha para descargar el informe correspondiente.</div>
                    </div>
                </div>
                            ...
                            <tbody>
                                @foreach($cortes as $corte)
                                    <tr>
                                        ...
                                        <td>{{ $corte['archivo'] ?? '' }}</td>
                                        <td>
                                            <a href="{{ route('settings.estadisticas_siniestros.actividades.descargar', $corte['fecha']) }}" class="btn sv-btn">
                ...
                @else
                    <div class="sv-empty">
                        ...
                        <div class="sv-empty__title">No hay informes disponibles</div>
                        <div class="sv-empty__desc">Cuando existan informes de actividades aparecerán aquí.</div>
                    </div>
                @endif
            </div>
        </div>
...
@section('js')
    <script> console.log('Actividades'); </script>
@stop
