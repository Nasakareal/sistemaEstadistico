...
class EstadoFuerzaSheetService extends BaseFomentoSheetService
{
    ...
    public function generar(Worksheet $sheet, Collection $personal, string $fecha, Carbon $inicio, Carbon $fin): void
    {
        $navy = '0B2A5B';
        $lightBlue = 'BDD7EE';
        $outsideGray = 'A6A6A6';
        ...
        $sheet->setCellValue('B4', 'CULTURA VIAL');
    ...
    private function conteosPorCategoriaFija(Collection $personal, Carbon $corte): array
    {
        ...
        foreach ($personal as $elemento) {
            ...
            $estado = $this->estadoService->estado($elemento, $corte);
