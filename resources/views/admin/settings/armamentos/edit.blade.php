                                ...
                                <div class="form-group">
                                    ...
                                    >
                                        ...
                                        @foreach ($unidades as $u)
                                            <option value="{{ $u->id }}"
                                                {{ (string)old('unidad_id', $armamento->unidad_id) === (string)$u->id ? 'selected' : '' }}>
                                                {{ $u->nombre }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        required
                                    >
                                        <option value="" disabled {{ old('estatus', $armamento->estatus) ? '' : 'selected' }}>
                                            Seleccione
                                        </option>

                                        <option value="ACTIVO" {{ old('estatus', $armamento->estatus) == 'ACTIVO' ? 'selected' : '' }}>
                                            ACTIVO
                                        </option>
                                        <option value="BAJA" {{ old('estatus', $armamento->estatus) == 'BAJA' ? 'selected' : '' }}>
                                            BAJA
                                        </option>
                                        <option value="RESGUARDO" {{ old('estatus', $armamento->estatus) == 'RESGUARDO' ? 'selected' : '' }}>
                                            RESGUARDO
                                        </option>
                                        <option value="MANTENIMIENTO" {{ old('estatus', $armamento->estatus) == 'MANTENIMIENTO' ? 'selected' : '' }}>
                                            MANTENIMIENTO
                                        </option>
                                    </select>
                                    @error('estatus')
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('clase', $armamento->clase) }}"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('calibre', $armamento->calibre) }}"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('matricula', $armamento->matricula) }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('marca', $armamento->marca) }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('modelo', $armamento->modelo) }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('serie', $armamento->serie) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    >{{ old('observaciones', $armamento->observaciones) }}</textarea>
                                    @error('observaciones')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
