...
@section('title', 'Excel Diario Delegaciones')
    ...
    <div class="sv-hero">
        <div class="sv-hero__inner">
            <div class="sv-hero__badge">
                ...
                <span>Delegaciones · Excel Diario · Cortes</span>
            </div>

            <div class="sv-hero__title">
                Excel Diario Delegaciones
            </div>
            ...
            <div class="sv-panel">
                ...
                @else
                    <div class="sv-empty">
                        ...
                        <div class="sv-empty__desc">Cuando existan Excel diarios de delegaciones aparecerán aquí.</div>
                    </div>
                @endif
            </div>
        </div>
