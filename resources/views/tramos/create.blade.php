                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.0000001" name="lat_inicio" id="lat_inicio"
                                           ...
                                           value="{{ old('lat_inicio') }}" placeholder="Ej: 19.7000000">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.0000001" name="lng_inicio" id="lng_inicio"
                                           ...
                                           value="{{ old('lng_inicio') }}" placeholder="Ej: -101.1850000">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.0000001" name="lat_fin" id="lat_fin"
                                           ...
                                           value="{{ old('lat_fin') }}" placeholder="Ej: 19.7100000">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.0000001" name="lng_fin" id="lng_fin"
                                           ...
                                           value="{{ old('lng_fin') }}" placeholder="Ej: -101.1750000">
