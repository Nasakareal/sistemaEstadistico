    ...
    <div class="sv-hero">
        <div class="sv-hero__inner">
            <div class="sv-hero__badge">
                ...
                <span>Siniestros · Bitácora · Cortes</span>
            </div>
            ...
            <div class="sv-hero__subtitle">
                Listado de bitácoras generadas para descarga
            </div>
        </div>
    </div>
@stop
        ...
        <div class="col-12">
            <div class="sv-panel">
                <div class="sv-panel__header">
                    <div>
                        <div class="sv-panel__title">Bitácoras generadas</div>
                        <div class="sv-panel__desc">Selecciona una fecha para descargar la bitácora correspondiente.</div>
                    </div>
                </div>
                            ...
                            <tbody>
                                @foreach($cortes as $corte)
                                    <tr>
                                        <td>{{ $corte['fecha'] ?? '' }}</td>
                                        <td>
                                            <a href="{{ route('settings.estadisticas_siniestros.bitacora.descargar', $corte['fecha']) }}" class="btn sv-btn">
                ...
                @else
                    <div class="sv-empty">
                        ...
                        <div class="sv-empty__title">No hay bitácoras disponibles</div>
                        <div class="sv-empty__desc">Cuando se generen bitácoras aparecerán aquí.</div>
                    </div>
                @endif
            </div>
        </div>
