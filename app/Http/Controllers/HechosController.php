...
class HechosController extends Controller
{
    ...
    public function compartirPublico(Hechos $hecho)
    {
        $hecho->load(['vehiculos']);
        ...
        $media = array_values(array_unique(array_filter($media)));

        return view('hechos.compartir_publico', compact('hecho', 'message', 'media'));
    }
}
