    ...
    <style>
        ...
        *{ box-sizing: border-box; }
        ...
        .card:before{
            ...
            width: 170px;
            height: 170px;
            background: radial-gradient(circle at 30% 30%, rgba(45,168,255,.22), transparent 60%);
            filter: blur(0px);
            pointer-events:none;
        }
...
<body>
    ...
    <div class="navbar-fixed">
        <div class="nav-inner">
            <a class="brand" href="{{ url('/') }}">
                <span class="badge"><i class="fa-solid fa-location-dot"></i></span>
                <span>Licencias · Ubicaciones</span>
            </a>
    ...
    <div class="wrap">
        ...
        <div class="hero">
            ...
            <p>Consulta dirección y horario de cada módulo.</p>
        </div>
        ...
        <div class="grid">
            @foreach ($ubicaciones as $ubicacion)
                <div class="card">
                    ...
                    <div class="meta">
                        <div class="line">
                            <div class="ico"><i class="fa-solid fa-map-pin"></i></div>
                            <div>
                                <b>Dirección</b>
