    ...
    <div class="sv-hero">
        <div class="sv-hero__inner">
            <div class="sv-hero__badge">
                ...
                <span>Siniestros · Mini Parte · Cortes</span>
            </div>
            ...
            <div class="sv-hero__subtitle">
                Listado de mini partes generados para descarga
            </div>
        </div>
    </div>
@stop
        ...
        <div class="col-12">
            <div class="sv-panel">
                <div class="sv-panel__header">
                    <div>
                        <div class="sv-panel__title">Mini partes generados</div>
                        <div class="sv-panel__desc">Selecciona una fecha para descargar el mini parte correspondiente.</div>
                    </div>
                </div>
                            ...
                            <tbody>
                                @foreach($cortes as $corte)
                                    <tr>
                                        <td>{{ $corte['fecha'] ?? '' }}</td>
                                        <td>
                                            <a href="{{ route('settings.estadisticas_siniestros.mini_parte.descargar', $corte['fecha']) }}" class="btn sv-btn">
                ...
                @else
                    <div class="sv-empty">
                        ...
                        <div class="sv-empty__title">No hay mini partes disponibles</div>
                        <div class="sv-empty__desc">Cuando se generen mini partes aparecerán aquí.</div>
                    </div>
                @endif
            </div>
        </div>
