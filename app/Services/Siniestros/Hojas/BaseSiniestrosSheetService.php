...
abstract class BaseSiniestrosSheetService
{
    ...
    protected function periodoTexto(
        Carbon $inicio,
        Carbon $fin
    ): string {
        return $inicio->format('d/m/Y H:i')
            . ' - '
    ...
    {
        return (int) ($actividad->personas_alcanzadas ?? 0);
    }
