                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="marca" id="marca" class="form-control @error('marca') is-invalid @enderror" 
                                           value="{{ old('marca', $vehiculo->marca) }}" placeholder="Ingrese la marca" required>
                                    @error('marca')
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="color" id="color" class="form-control @error('color') is-invalid @enderror" 
                                           value="{{ old('color', $vehiculo->color) }}" placeholder="Ingrese el color" required>
                                    @error('color')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="tel" name="telefono" id="telefono"
                                           ...
                                           value="{{ old('telefono', $conductor ? $conductor->telefono : '') }}" placeholder="Ingrese el teléfono del conductor" pattern="[0-9]{10}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ocupacion" id="ocupacion"
                                           ...
                                           value="{{ old('ocupacion', $conductor ? $conductor->ocupacion : '') }}" placeholder="Ingrese la ocupación del conductor" required>
                                    @error('ocupacion')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tipo_licencia" id="tipo_licencia"
                                           ...
                                           value="{{ old('tipo_licencia', $conductor ? $conductor->tipo_licencia : '') }}" placeholder="Ingrese el tipo de licencia" required>
                                    @error('tipo_licencia')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="estado_licencia" id="estado_licencia"
                                           ...
                                           value="{{ old('estado_licencia', $conductor ? $conductor->estado_licencia : '') }}" placeholder="Ingrese el estado de la licencia" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="vigencia_licencia" id="vigencia_licencia"
                                           ...
                                           value="{{ old('vigencia_licencia', $conductor ? $conductor->vigencia_licencia : '') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="numero_licencia" id="numero_licencia"
                                           ...
                                           value="{{ old('numero_licencia', $conductor ? $conductor->numero_licencia : '') }}" placeholder="Ingrese el número de licencia" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <textarea name="danos_patrimoniales" id="danos_patrimoniales"
                                              ...
                                              placeholder="Describa los daños patrimoniales" required>{{ old('danos_patrimoniales', $hecho->danos_patrimoniales ?? '') }}</textarea>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="propiedad" id="propiedad"
                                           ...
                                           value="{{ old('propiedad', $hecho->propiedades_afectadas ?? '') }}" placeholder="Ingrese el nombre del propietario afectado" required>
                                    @error('propiedad')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="monto_danos_patrimoniales" id="monto_danos_patrimoniales"
                                           ...
                                           value="{{ old('monto_danos_patrimoniales', $hecho->monto_danos_patrimoniales ?? '') }}" placeholder="Ingrese el monto estimado" min="0" step="0.01" required>
