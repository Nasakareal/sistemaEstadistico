...
@section('title', 'Edición Operativa del Dispositivo')

@section('content_header')
    <h1>Edición Operativa del Dispositivo</h1>
@stop

@section('content')
    @php
        $vialidadUrbanaId = $vialidadUrbana ?? 1;
        $detallesForm = old('detalles', $dispositivo->detalles->map(function ($detalle) {
            return [
                'tipo' => $detalle->tipo,
                'titulo' => $detalle->titulo,
                'contenido' => $detalle->contenido,
                'ubicacion' => $detalle->ubicacion,
                'hora' => !empty($detalle->hora) ? substr((string) $detalle->hora, 0, 5) : '',
            ];
        })->toArray());
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('vialidades_urbanas.dispositivos.update', [$vialidadUrbanaId, $dispositivo->id]) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                @csrf
                @method('PUT')
                ...
                <div class="card card-outline card-primary">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ route('vialidades_urbanas.dispositivos.index', [$vialidadUrbanaId, $dispositivo->id]) }}" class="btn btn-secondary btn-sm">
                                <i class="fa-solid fa-arrow-left"></i> Volver
                            </a>

                            <button type="submit" class="btn btn-primary btn-sm">
                                <i class="fa-solid fa-floppy-disk"></i> Actualizar información
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div id="contenedor-detalles">
                            @foreach($detallesForm as $i => $detalle)
                    ...
                    <div class="card-footer text-right">
                        <a href="{{ route('vialidades_urbanas.dispositivos.index', [$vialidadUrbanaId, $dispositivo->id]) }}" class="btn btn-secondary">
